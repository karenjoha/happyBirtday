...
let trackList = [
    {
        ...
        artist: "Yo",
        path: "./music/Feliz_cumpleaños_a_todos.mp3",
    },
    {
        name: "Feliz Cumpleaños, parte 2",
        artist: "Otra vez yo",
        path: "./music/Happy_Birthday _To_You.mp3",
    },
    {
        name: "Feliz Cumpleaños, Ya entrados en gastos",
        artist: "Hi, si soy yo",
        path: "./music/Cumpleaños_Diomedes_Díaz.mp3",
    },
];
